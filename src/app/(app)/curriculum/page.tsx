    ...
    <main className="min-h-screen bg-slate-100 px-4 py-6 sm:px-6">
      <div className="mx-auto max-w-[1600px]">
        <header className="mb-6">
          ...
          <p className="mt-2 max-w-3xl text-slate-600">Explore official ITU undergraduate plans, check prerequisites, and keep your passed and failed courses locally in this browser.</p>
        </header>
